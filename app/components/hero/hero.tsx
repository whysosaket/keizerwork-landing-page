  ...
  return (
    <div>
      <div className="p-4 max-w-8xl mx-auto relative z-10 w-full pt-20 md:pt-0">
        <h1 className="[animation-delay:_0.2s] opacity-0 text-4xl md:text-8xl font-bold animate-unblur text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50">
          <span className="">KeizerWorks</span> <br />
        </h1>
        <h1 className="[animation-delay:_0.5s] opacity-0 text-4xl md:text-8xl font-bold animate-unblur text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50">
          is the new trend.
        </h1>
      ...
      {/* Book a call button */}
      <div className="flex justify-center items-center [animation-delay:_0.9s] opacity-0 animate-unblur">
