  ...
  return (
    <div className="w-full py-4 text-white">
      <div className="w-5/6 mx-auto animate-unblur flex align-middle justify-between items-center rounded-2xl px-4 py-2">
        ...
        >
          <div className="flex justify-between items-center w-12 h-10 overflow-hidden">
            <Image
              ...
              width={70}
              height={70}
              className="m-auto relative bottom-1"
            />
          </div>
        ...
        >
          <h1 className="my-auto cursor-pointer hover:text-gray-300 bg-white/10 px-3 rounded-3xl py-1">
            Product
          </h1>
          <h1 className="my-auto cursor-pointer hover:text-gray-300 hover:bg-white/5 px-3 rounded-3xl py-1">
            Development
          </h1>
          <h1 className="my-auto cursor-pointer hover:text-gray-300 hover:bg-white/5 px-3 rounded-3xl py-1">
            Design
        ...
        >
          <Button
            variant={"secondary"}
            className="my-auto rounded-3xl px-3 py-1 cursor-pointer"
          >
            Get Started
          </Button>
        </motion.div>
